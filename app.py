...
function_option2=st.selectbox("Select The Funtionality: ", ["Top 10 @Mentions in Tweets", "Top 10 Hastags used in tweets"])
...
if st.button("Analysis Sentiment"):
    ...
    if function_option2 == 'Top 10 @Mentions in Tweets':
            st.text("Top 10 @Mentions in {} tweets".format(number_of_tweets))
            st.bar_chart(mention)
    if function_option2 == 'Top 10 Hastags used in tweets':
